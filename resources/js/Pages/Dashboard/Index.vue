                                    ...
                                    <div class="ml-5 w-0 flex-1">
                                        <dl>
                                            ...
                                            <dd class="flex items-baseline">
                                                <div class="text-2xl font-semibold text-gray-900">$24,000</div>
...
const recentActivity = [
    {
        ...
        description: 'John Doe donated $500 to Eco-Friendly Water Bottle project',
        status: 'Completed',
    ...
    {
        id: 2,
        title: 'Project goal reached',
        description: 'Community Garden Initiative has reached its funding goal',
        status: 'Success',
        statusClass: 'bg-green-100 text-green-800',
        date: '5 hours ago'
    },
    {
        ...
        description: 'Local Art Exhibition has been created',
        status: 'Active',
